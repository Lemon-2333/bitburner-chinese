...
export const TerminalHelpText: string[] = [
  i18n.t('help.more',{ns:'help'}),
  ` `,
  `    alias [-g] [name="value"]            ${i18n.t('help.alias',{ns:'help'})}`,
  `    analyze                              ${i18n.t('help.analyze',{ns:'help'})}`,
  `    backdoor                             ${i18n.t('help.backdoor',{ns:'help'})}`,
  `    buy [-l/-a/program]                  ${i18n.t('help.buy',{ns:'help'})}`,
  `    cat [file]                           ${i18n.t('help.cat',{ns:'help'})}`,
  `    cd [dir]                             ${i18n.t('help.cd',{ns:'help'})}`,
  `    check [script] [args...]             ${i18n.t('help.check',{ns:'help'})}`,
  `    clear                                ${i18n.t('help.clear',{ns:'help'})}`,
  `    cls                                  ${i18n.t('help.cls',{ns:'help'})}`,
  `    connect [hostname]                   ${i18n.t('help.connect',{ns:'help'})}`,
  `    cp [src] [dst]                       ${i18n.t('help.cp',{ns:'help'})}`,
  `    download [script/text file]          ${i18n.t('help.download',{ns:'help'})}`,
  `    expr [math expression]               ${i18n.t('help.expr',{ns:'help'})}`,
  `    free                                 ${i18n.t('help.free',{ns:'help'})}`,
  `    grow                                 ${i18n.t('help.grow',{ns:'help'})}`,
  `    hack                                 ${i18n.t('help.hack',{ns:'help'})}`,
  `    help [command]                       ${i18n.t('help.help',{ns:'help'})}`,
  `    history [-c]                         ${i18n.t('help.history',{ns:'help'})}`,
  `    home                                 ${i18n.t('help.home',{ns:'help'})}`,
  `    hostname                             ${i18n.t('help.hostname',{ns:'help'})}`,
  `    kill [script/pid] [args...]          ${i18n.t('help.kill',{ns:'help'})}`,
  `    killall                              ${i18n.t('help.killall',{ns:'help'})}`,
  `    ls [dir] [--grep pattern]            ${i18n.t('help.ls',{ns:'help'})}`,
  `    lscpu                                ${i18n.t('help.lscpu',{ns:'help'})}`,
  `    mem [script] [-t n]                  ${i18n.t('help.mem',{ns:'help'})}`,
  `    mv [src] [dest]                      ${i18n.t('help.mv',{ns:'help'})}`,
  `    nano [file ...]                      ${i18n.t('help.nano',{ns:'help'})}`,
  `    ps                                   ${i18n.t('help.ps',{ns:'help'})}`,
  `    rm [file]                            ${i18n.t('help.rm',{ns:'help'})}`,
  `    run [name] [-t n] [--tail] [args...] ${i18n.t('help.run',{ns:'help'})}`,
  `    scan                                 ${i18n.t('help.scan',{ns:'help'})}`,
  `    scan-analyze [d] [-a]                ${i18n.t('help.scan_analyze',{ns:'help'})}`,
  `    scp [file ...] [server]              ${i18n.t('help.scp',{ns:'help'})}`,
  `    sudov                                ${i18n.t('help.sudov',{ns:'help'})}`,
  `    tail [script] [args...]              ${i18n.t('help.tail',{ns:'help'})}`,
  `    top                                  ${i18n.t('help.top',{ns:'help'})}`,
  `    unalias [alias name]                 ${i18n.t('help.unalias',{ns:'help'})}`,
  `    vim [file ...]                       ${i18n.t('help.vim',{ns:'help'})}`,
  `    weaken                               ${i18n.t('help.weaken',{ns:'help'})}`,
  `    wget [url] [target file]             ${i18n.t('help.wget',{ns:'help'})}`,
  ` `,
];
